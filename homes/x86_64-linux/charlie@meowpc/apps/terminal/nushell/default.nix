{
  programs.nushell = {
    ...
    shellAliases = {
      ...
      code = "codium";
      mount_data = "sudo mount -o uid=1000 -t bcachefs /dev/disk/by-partuuid/fdc75711-559a-4908-9eda-5a912a6440b4:/dev/disk/by-partuuid/8209bc50-fb37-432c-b137-13d97ad65478:/dev/disk/by-partuuid/3ddfb494-022b-44c9-9f3e-e13c7985b847 /data";
    };
    extraConfig = ''
